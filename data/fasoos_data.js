let data = [
    {
        ...
        type: "veg",
        price: 198,
        discription: '(Veg Only) 1 Masala Paneer Tikka Wrap + 1 Jumbo Falafel Salsa Wrap . When flavourful surprises come knocking, you welcome them with open arms. Especially when they come with savings of Rs.137!',
        tags: ['Veg', 'wrap'],
    ...
    },
    {
        ...
        type: "veg",
        price: 209,
        discription: "(Veg Only) 1 Jumbo Paneer Chole Wrap + 1 Jumbo Falafel Salsa Wrap. When dill mange more but pockets say please no more, we come to the rescue! Save Rs. 181 with this FAB combo of",
        tags: ['veg', 'wrap'],
    ...
    },
    {
        ...
        type: "veg",
        price: 219,
        discription: "(Veg Only) Get a fusion of flavours and a surprise of savings with this combo. 1 Mexican Potato Salsa Wrap + 1 Makhni Falafel Wrap",
        tags: ['veg', 'wrap'],
    ...
    },
    {
        ...
        type: "non-veg",
        price:239,
        discription: '(Non-Veg Only) Save Rs. 146 with this delicious combo of 1 BBQ Chicken Overload Wrap + 1 Masala Chicken Tikka Wrap. An overload of flavours, an overload of savings, we have it all!',
        tags: ['Non veg', 'wrap'],
    ...
    },
    {
        ...
        type: "non-veg",
        price: 269,
        discription: '(Veg + Non-Veg) 1 Baked Veggie Pizza Wrap + 1 Baked Chicken Pizza Wrap. Delicious surprises and amazing savings are in the ‘baking’! Indulge in this FAB combo and save Rs.171.',
        tags: ['Non veg', 'wrap'],
    ...
    },
    {
        ...
        type: "non-veg",
        price: 279,
        discription: '(Non-Veg Only) 1 BBQ Chicken Overload Wrap + 1 American Smokey Sausage Wrap. Delicious wraps, unbelievable savings of Rs.181!',
        tags: ['Non veg', 'wrap'],
